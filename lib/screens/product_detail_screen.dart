            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          widget.product.stock > 0 ? 'En Stock' : 'Agotado',
                          style: GoogleFonts.poppins(
                            color: widget.product.stock > 0
                                ? Colors.green[800]
                                : Colors.red[800],
                  ...
                  if (widget.product.bulkPrice != null &&
                      widget.product.minBulkQuantity != null)
                    Container(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Compra ${widget.product.minBulkQuantity}+ por \$${widget.product.bulkPrice!.toStringAsFixed(2)} cada uno',
                                  style: GoogleFonts.poppins(
                                    fontSize: 12,
                                    color: AppColors.textSecondary,
                                  ),
                  ...
                  onPressed: widget.product.stock > 0
                      ? () {
                          ...
                          _showSuccessSnackBar(
                            context,
                            '${widget.product.name} (x$quantity) añadido al carrito',
                          );
                        }
                      : null,
